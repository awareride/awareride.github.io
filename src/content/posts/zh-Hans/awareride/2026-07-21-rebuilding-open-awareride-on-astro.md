...
> **更新(2026-08):** open.awareride.com 现已基于
> [astro-content-hub](https://github.com/awareride/astro-content-hub) 模板重建 --
> 统一的 `[locale]` 路由、数据驱动的产品注册表、逐产品的落地页与站内搜索。
> 以下系列记录了第一个 Astro 站点的构建过程,其描述的架构已被取代。
...
[部署到 GitHub Pages 与 Cloudflare Pages](/zh-Hans/posts/awareride/2026-07-21-deploying-to-github-and-cloudflare-pages/),
接着是[带逐页回退的两种语言](/zh-Hans/posts/awareride/2026-07-22-two-locales-with-per-page-fallback/),
最后是[通过 Pull Request 同步的内容中心](/zh-Hans/posts/awareride/2026-07-22-a-content-hub-synced-via-pull-requests/)。*
