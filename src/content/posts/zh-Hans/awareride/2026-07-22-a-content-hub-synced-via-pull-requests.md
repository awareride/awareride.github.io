...
间必须逐字节一致。`en/getting-started.md` 配 `zh-Hans/getting-started.md` -- 绝不是
`zh-Hans/Getting-Started.md` -- 否则逐页回退会坏。
...
源 Markdown 保留对 GitHub 友好的相对链接 -- `./getting-started.md`、`../zh-Hans/architecture.md`。
...
[不用 Starlight,做带逐页回退的两种语言](/zh-Hans/posts/awareride/2026-07-22-two-locales-with-per-page-fallback/)。
下一篇:[一个不会消失的移动端导航](/zh-Hans/posts/awareride/2026-07-22-a-mobile-nav-that-does-not-vanish/)。*
