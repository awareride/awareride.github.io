...
URL 的抉择:`/zh-Hans/packscope/docs/` 还是 `/packscope/docs/zh-Hans/`?我选了语言在前。`en` 是默认语言,
没有前缀;其它语言都活在 `/<locale>/...` 下:

- `https://open.awareride.com/packscope/docs/getting-started` -- 英文
- `https://open.awareride.com/zh-Hans/packscope/docs/getting-started` -- 中文

整站都照此镜像:`/zh-Hans/`、`/zh-Hans/packscope/`、`/zh-Hans/posts/`。一条规则,到处适用。
...
你可以先发英文,再增量翻译。站点永远不会坏,只是在缺中文的地方显示英文加一条提示。`/zh-Hans/posts/`
...
[用一个工作流同时部署到 GitHub Pages 与 Cloudflare Pages](/zh-Hans/posts/awareride/2026-07-21-deploying-to-github-and-cloudflare-pages/)。
下一篇:[通过 Pull Request 同步的内容中心](/zh-Hans/posts/awareride/2026-07-22-a-content-hub-synced-via-pull-requests/)。*
